...
url = "https://myrtlebeach.craigslist.org/d/cars-trucks/search/cta"
...
for container in containers:
    ...
    if model != "" and year != "" and make != "" and model != "sierra" and model != "outback" and price != "spam":
        chromepath = "/Users/Jacob/Downloads/chromedriver"
        driver = webdriver.Chrome(chromepath)
        wait = WebDriverWait(driver, 100)
        driver.get('https://www.kbb.com/used-cars/')


        select = Select(driver.find_element_by_xpath("//*[@id='yearDropdown0']"))
        select.select_by_value(year)
        time.sleep(1)

        elem = driver.find_element_by_xpath("//*[@id='makeDropdown0']")
        elem.send_keys(make)
